...
const TeacherCourses=()=>{
    ...
    const SignedIn=(e)=>{
        e.preventDefault();
        if(id==='student'){
            axios.post('http://localhost:9000/register',{name,email,role:'student',password}).then(result=>console.log(result)).catch(err=>console.log(err));
        }else if(id==='faculty'){
        ...
        <div class="col-10 col-md-6 mx-2 px-5 my-5 py-4 styleDiv">
            <form id="registerForm" method="post" onSubmit={SignedIn}>
                ...
                {(id==='student') && 
                    ...
                    <div><input type="radio" name="sem" onChange={(event) => setSemValue(event.target.value)} required></input><label class="abel-500" style={{fontSize: '1rem'}} >&nbsp;1</label></div>
                    <div><input type="radio" name="sem" onChange={(event) => setSemValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;2</label><br></br></div>
                    <div><input type="radio" name="sem" onChange={(event) => setSemValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;3</label><br></br></div>
                    <div><input type="radio" name="sem" onChange={(event) => setSemValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;4</label><br></br></div>
                    <div><input type="radio" name="sem" onChange={(event) => setSemValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;5</label><br></br></div>
                    <div><input type="radio" name="sem" onChange={(event) => setSemValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;6</label><br></br></div>
                    <div><input type="radio" name="sem" onChange={(event) => setSemValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;7</label><br></br></div>
                    <div><input type="radio" name="sem" onChange={(event) => setSemValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;8</label><br></br></div>
                </div>
                <div style={{marginTop: '2rem'}}>
                    <label class="abel-500" style={{fontSize: '1.2rem'}}>Section</label>
                    
                    <div><input type="radio" name="sec" onChange={(event) => setSecValue(event.target.value)} required></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;1</label></div>
                    <div><input type="radio" name="sec" onChange={(event) => setSecValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;2</label><br></br></div>
                    <div><input type="radio" name="sec" onChange={(event) => setSecValue(event.target.value)}></input><label class="abel-500" style={{fontSize: '1rem'}}>&nbsp;3</label><br></br></div>
                </div>
                    </>
                }
                {(id==='faculty' && 
